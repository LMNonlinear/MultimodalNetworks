...
switch mode
    ...
    case 2
        ...
        [sSrcResults,sSrcResultsFile]=fun_hcp_meg_inverse_pipeline(ProtocolName,data_dir,SubjectName);
        [niftiFilePath]= fun_hcp_meg_saveas_nifti(SubjectName,sSrcResults);
        toc
end
