...
% fmriNiftiPath=['..\result\',subjectName,'.',kiloVertices,'.surface.matched.fMRI_REST_LR.nii'];
% megNiftiPath=['..\result\',subjectName,'.',kiloVertices,'.source.matched.MEG_REST_LR.nii'];
%
