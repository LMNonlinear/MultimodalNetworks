%%
%this code is for comparing different downsampled fmri data,such as: 
%compare 32k to 8k with downsampleing the anatomical surface with 32k to 8k without downsampleing the anatomical surface
...
%% fMRI signal 32kto6k
surfSignal(1).path_fmri={'F:\MEEGfMRI\Data\SignalComparing\data\105923.rs.from32k.3k.rfMRI_REST1_LR_Atlas_hp2000_clean.L.nii'...
'F:\MEEGfMRI\Data\SignalComparing\data\105923.rs.from32k.3k.rfMRI_REST1_LR_Atlas_hp2000_clean.R.nii'};
surfSignal(1).signal_fmri=niftiopen(surfSignal(1).path_fmri);
%% fmri signal 8kto6k
surfSignal(2).path_fmri={'F:\MEEGfMRI\Data\SignalComparing\data\105923.rs.3k.rfMRI_REST1_LR_Atlas_hp2000_clean.L.nii'...
'F:\MEEGfMRI\Data\SignalComparing\data\105923.rs.3k.rfMRI_REST1_LR_Atlas_hp2000_clean.R.nii'};
